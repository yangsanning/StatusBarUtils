...
public class StatusBarUtils {
     ...
     * 设置状态栏颜色(自定义颜色)
     */
    public static void setColor(@NonNull Activity activity, @ColorInt int color, View... views) {
    ...
    /**
     * 设置状态栏LightMode, 字体颜色及icon变亮(目前支持MIUI6以上, Flyme4以上, Android M以上)
     */
